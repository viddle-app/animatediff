...
class Text2ImageDataset:
    ...
    # Get the training dataset
        self._train_dataset = WebVid10M(**train_data, is_image=True)
        ...
        self._train_dataset = torch.utils.data.DataLoader(
            self._train_dataset,
...
def main(args):
    ...
    num_update_steps_per_epoch = 100 # math.ceil(train_dataloader.num_batches / args.gradient_accumulation_steps)
    ...
    logger.info(f"  Num batches each epoch = {100}")
