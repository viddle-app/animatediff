        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps * partition_count) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # TODO 
                # I need to start by offset half the window length.
                # I should end by not offsetting at all.
                # based on the number of steps between the two
                ...
                for p, partition_indices in enumerate(indices):
                    ...
                    # if it has _step_index we need reset it
