...
class MultiControlNetModel(ModelMixin):
    ...
    def forward(
        ...
        print("MultiControlNetModel.forward()")
        print("controlnet_cond", len(controlnet_cond))
        print("conditioning_scale", len(conditioning_scale))
        print("self.nets", len(self.nets))
