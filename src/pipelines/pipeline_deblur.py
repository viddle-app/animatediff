...
class PipelineDeblur(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        **kwargs,
        ...
        >>> from diffusers import PipelineDeblur
        ...
        >>> pipe = PipelineDeblur.from_pretrained(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.do_classifier_free_guidance:
                    ...
                    # )
                    noise_pred_uncond = (latents - image_latents[0:1]) 
                    # TODO based on the timestep I need to scale the noise_pred_uncond
                    noise_pred = (
                        noise_pred_uncond
                        + self.guidance_scale
