...
from src.utils.convert_from_ckpt import convert_ldm_vae_checkpoint, convert_ldm_unet_checkpoint, convert_ldm_clip_checkpoint
from src.utils.convert_lora_safetensor_to_diffusers import convert_lora, load_diffusers_lora
...
def load_weights(
    ...
    if dreambooth_model_path != "":
        ...
        print(f"vae: {converted_vae_checkpoint.keys()}")
